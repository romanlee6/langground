...
for seed in seeds:
    for method in methods:
        ...
        run_str = f"python exp_dragon.py --env_name {env} --nagents {nagents} --nprocesses {nprocesses} " + \
                  ...
                  f"--exp_name {exp_name} --save_every {save_every} --load '../gym-dragon/scripts/trained_models/' "
        # print(run_str)
        if restore:
            run_str += f"--restore "
